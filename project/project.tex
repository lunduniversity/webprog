...
\item Fetching data using http requests. You write an app that gather data from at least source and present them to the user. Use the angular \code{http} object for fetching data. There are plenty of open data sources, for example: \url{https://www.dataportal.se}, \url{http://www.omdbapi.com}, \url{https://openlibrary.org/dev/docs/api/books}, \url{https://www.openstreetmap.org}
