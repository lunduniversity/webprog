...
\begin{itemize}
\item no compilation $\rightarrow$ no compilation errors $\rightarrow$ you need to test more
\item JS language design leads to:
  \begin{itemize}
  \item many silent errors
  \item weird and unexpected behaviour in some contexts
...
\begin{frame}[fragile]
  ...
  \\If missing, a semicolon is added at the end of a line.
