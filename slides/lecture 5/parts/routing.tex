...
\begin{itemize}
  ...
  \item error handling
  \begin{itemize}
    \item \code{errorComponent} -- an object (JSX expression)
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item path: \code{/first-segment/next-segment}
    \item matches url: \code{/first-segment/next-segment}
  \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item instead the \code{errorComponent/ErrorBoundary} is
  \begin{itemize}
    \item \code{errorComponent} -- an object (JSX expression)
    \item \code{ErrorBoundary} -- a react component (JavaScript function)
    \item use one of them
