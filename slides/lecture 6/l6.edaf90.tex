...
\newtcblisting{CodeBox}[2][]{% Only code
  ...
  listing options={
    ...
    morekeywords= {await, undefined, NaN, function, export, var, let, async}
  },
  title=#2,#1
}
...
%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%
\title[Concurrency and async]{Concurrency and async}
\author[EDAF90]{%
...
%---concurrency ---------------------------------------------------
\include{parts/concurrency}

%---promise ---------------------------------------------------
\include{parts/promise}
