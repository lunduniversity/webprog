...
\noindent \emph{Reflection Question 3:} What is the meaning of a leading / in a path, the difference between \code{<Link to="view-order/confirm/123e4567-e89b-12d3-a456-426614174000" />} and \code{<Link to="/view-order/confirm/123e4567-e89b-12d3-a456-426614174000" />}. Try it, look in the browser url field.
