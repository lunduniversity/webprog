...
\noindent \emph{Reflection Question 2:} What is the difference between using \code{<Link>} and \code{<NavLink>} in your navigation bar?
...
\\ \code{http://localhost:3000/} $\rightarrow$ This is the first page of your app, render a welcome message. \emph{hint:} \code{index} attribute, \url{https://reactrouter.com/en/main/start/tutorial#index-routes}
