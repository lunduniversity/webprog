...
On the course canvas page you find the instructions for creating a new react project, see \url{https://canvas.education.lu.se/courses/17001/pages/react-skapa-ett-projekt}. Later you will store a list of salads in the App component. Function components do not have a state so you must change it to class:
\begin{Code}
